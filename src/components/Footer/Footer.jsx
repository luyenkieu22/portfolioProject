          ...
          <div className="w-full sm:w-1/2">
            ...
            <div className="flex items-center gap-4 flex-wrap md:gap-8 mt-10">
              ...
              <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://github.com/luyenkieu22"
              ...
              <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                <a
                  href="https://www.facebook.com/luyen.kieu.295129"
                  className="text-gray-300 font-[500] text-[18px]"
                >
        ...
        <div>
          <ul className="flex items-center justify-center gap-10 mt-10">
            <li>
              <a
                href="#about"
                className="text-gray-400 items-center justify-center font-[600]"
              >
                About
              </a>
            </li>
          ...
          <div className="flex items-center justify-center sm:justify-between">
            <div className="hidden sm:block">
              <div className="flex items-center gap-[10px]">
                <span className="w-[35px] h-[35px] bg-[#2b2d33] text-white font-[500] flex items-center justify-center text-[18px] rounded-full">
                  L
                </span>
            ...
            <div>
              <p className="text-gray-400">
                Copyright {year} developed by Luyen Kieu - All right reserved.
              </p>
            </div>
          </div>
        </div>
